...
Version  : 1.1.tar
Release  : 4
URL      : https://github.com/clearlinux/usrbinjava/archive/v1.1.tar.gz
Source0  : https://github.com/clearlinux/usrbinjava/archive/v1.1.tar.gz
...
%prep
%setup -q -n usrbinjava-1.1
cd %{_builddir}/usrbinjava-1.1
...
cp %{_builddir}/usrbinjava-1.1/COPYING.Apache-2.0 %{buildroot}/usr/share/package-licenses/usrbinjava/2b8b815229aa8a61e483fb4ba0588b8b6c491890
%make_install
